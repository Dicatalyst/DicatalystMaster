...
namespace Admin
{
    public partial class Admin_Manage_Pharmacy : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (var excel_con = new OleDbConnection(conString))
            {
                ...
                {
                    new DataColumn("pharmacyName", typeof(string)),
                ...
                using (var con = new SqlConnection(consString))
                {
                    using (var sqlBulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        sqlBulkCopy.DestinationTableName = "dbo.pharmacy_Data";

                        //[OPTIONAL]: Map the Excel columns with that of the database table

                        sqlBulkCopy.ColumnMappings.Add("[Pharmacy Name]", "pharmacyName");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "deleterow")
            {
                ...
                mngmod.DeletePharmaData(Convert.ToInt32(lblId.Text));
                bindGridView();
            }
        }
