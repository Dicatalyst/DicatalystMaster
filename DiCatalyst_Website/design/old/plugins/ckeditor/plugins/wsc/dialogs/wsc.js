                ...
                contents: [
                    {
                        ...
                        elements: [
                            ...
                            },
                            {
                                ...
                                onShow: function() {
                                    this.getElement()
                                        .setStyles({ display: "block", position: "absolute", left: "-9999px" })
                                },
                                onHide: v,
                                children: [
                                    {
                                                                ...
                                                                children: [
                                                                    {
                                                                        ...
                                                                        onShow: function() {
                                                                            (this.getElement().getFirst() ||
                                                                                this.getElement()).setText(a
                                                                                .LocalizationComing.Create)
                                                                        },
                                                                        onClick: b
                                                                    }, {
                                                                        type: "button",
