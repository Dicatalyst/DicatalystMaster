<%@ Page Title="" Language="C#" MasterPageFile="~/Dentist/MasterPage.master" AutoEventWireup="true" CodeFile="Queries.aspx.cs" Inherits="Dentist_Queries" %>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="form-group col-lg-9">
                                      <b>To</b>
                                        ...
                                        <div class="form-group has-error">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ValidationGroup="Group31" ErrorMessage="Enter To (Name)" ControlToValidate="txtTo" class="error-message"></asp:RequiredFieldValidator>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-9">
                                      <b>Query</b>
                                        ...
                                        <asp:TextBox ID="txtQuery" runat="server" TextMode="multiline" Columns="60" Rows="2" CssClass="form-control" Width="100%"></asp:TextBox>

                                        <div class="form-group has-error">

                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Group31" ErrorMessage="Enter Query" ControlToValidate="txtQuery" class="error-message"></asp:RequiredFieldValidator>
                                ...
                                <div class="row" style="margin-left: 300px">
                                    ...
                                    <div class="form-group col-lg-2">
                                        <asp:Button ID="Button1" runat="server" Text="Submit" ValidationGroup="Group31" class="btn btn-info pull-right"/>
