<%@ Page Language="C#" AutoEventWireup="true" CodeFile="odonto.aspx.cs" Inherits="odonto" %>
        ...
        $.extend(SVGWrapper.prototype,
            {
                ...
                defs: function(parent, id, settings) {
                    ...
                    return this._makeNode(args.parent,
                        'defs',
                        $.extend(
                            (args.id ? { id: args.id } : {}),
                            args.settings || {}));
                ...
                style: function(parent, styles, settings) {
                    ...
                    var node = this._makeNode(args.parent,
                        'style',
                        $.extend(
                            { type: 'text/css' },
                            args.settings || {}));
                ...
                linearGradient: function(parent, id, stops, x1, y1, x2, y2, settings) {
                    ...
                    return this._gradient(args.parent,
                        'linearGradient',
