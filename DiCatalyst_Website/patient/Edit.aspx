    ...
    <div>
        <table border="0" cellspacing="4" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxStart" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">End:</td>
                <td>
                    <asp:TextBox ID="TextBoxEnd" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">Resource:</td>
                <td>
                    <asp:DropDownList ID="DropDownListRoom" runat="server" Width="200px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
