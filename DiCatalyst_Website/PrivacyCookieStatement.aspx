<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PrivacyCookieStatement.aspx.cs" Inherits="PrivacyCookieStatement" %>
...
<p>
    3D4Medical Limited, a company registered in Ireland with company number 389683 and registered office address of 48 Serpentine Ave, Ballsbridge, Dublin 4, 3D4Medical, LLC, a US corporation with a trading address at 445 Marine View Avenue Suite 110, Del Mar CA 92014 and 3D4Medical Inc, a US corporation with a trading address at 445 Marine View Avenue Suite 110, Del Mar CA 92014 (together "3D4Medical", "us", "we" or "our") are committed to protecting and respecting your privacy.
...
<ul>
    <li>your use of this application or website and any and all other websites or applications provided by, operated by or available for download from 3D4Medical (together the "Sites"); and</li>
    <li>any of the services accessible or available through the Sites (the "Services"), unless the Terms of Use states that a separate privacy statement applies to a particular Service, in which case that privacy statement only applies.</li>
</ul>
...
<ul>
    <li>Information relating to your identify (e.g. name, email address, physical address, username, demographic information, ZIP/postal code, password and other registration information);</li>
    <li>Information relating to your profession, your education, your title, your degree or certification, your affiliation with a professional organization or educational institution;</li>
    <li>Information relating to your method of payment (e.g. financial and credit card information);</li>
    <li>
    ...
    <li>Information relating to the follow-up of the commercial relationship (your requests, the features of the Services you use, exchanges between you and us, ratings or reviews that have been posted online); and</li>
    <li>
...
<h4>Information we collect about you and your device</h4>
<p>Each time you visit one of our, or use our, Sites or any of the Services we may automatically collect the following information:</p>
<ul>
    <li>technical information, including the type of device you use, a unique device identifier (for example, your Device's IMEI number, the MAC address of the Device's wireless network interface, or the mobile phone number used by the Device), web browser software, IP address, the type of mobile browser you use, time zone setting; and</li>
    <li>details of your use of the Sites and Services or your visits to any other of our sites including, but not limited to, traffic data, location data, weblogs and other communication data, whether this is required for our own billing purposes or otherwise and the resources that you access. One of our goals in collecting this automatic information is to help us understand the interests of our users and customize your user experience. To learn more about how we collect information through cookies and other tracking technologies, please refer to the Cookies and Other Web Technologies section below.</li>
</ul>
<h4>
    Information we obtain from third parties
</h4>
<p>We are working closely with third parties (including, for example, business partners, sub-contractors in technical, payment and delivery services, advertising networks, analytics providers, search information providers, credit reference agencies) and may receive information about you from them.</p>
...
<ul>
    <li>To enable personal identification within the Sites or for the provision of the Services, to register you as a member on the Sites or the Services, including to facilitate your access to and use of the Sites or Services;</li>
    <li>To provide you with general information on the Sites and to provide you with our Services;</li>
    <li>To respond to your requests for information, queries and other communication or correspondence you may submit to us;</li>
    <li>To ensure that content on the Sites is presented in the most effective manner for you and for your device;</li>
    <li>To provide you with information or Services that you request from us;</li>
    <li>To carry out our obligations arising from any contracts entered into between you and us and to enforce the terms of our Applicable Terms;</li>
    <li>To allow you to participate in interactive features of the Sites and/or the Services, when you choose to do so;</li>
    <li>To notify you about changes to the Sites, the Services or policies;</li>
    <li>To communicate with you in general (including for example and without limitation, via email, telephone or SMS), including to provide information about the Sites and/or the Services (please see the Marketing Communications Section below); and</li>
    <li>To gather management information to form statistical, modeling and trend analysis with the aim of developing and improving products and services.</li>
...
<p>We may make use of the information we have collected from you to enable us to comply with our advertisers' wishes by displaying their advertisement to that target audience. </p>
...
<p>We may disclose your personal data to third parties (including third parties who are not Contractors):</p>
<ul>
    <li>
    ...
    <li>For marketing purposes where we have your consent to do so in accordance with the Marketing Communication section below; or</li>
    <li>In order to enforce or apply the Applicable Terms and other agreements or to investigate potential breaches; </li>
...
<p>Our Sites use a service provided by Flurry Analytics to collect anonymous data from our users. This kind of information does not allow 3D4Medical to identify the user as a specific individual - in other words the data received from Flurry is anonymous. This information includes data on interface interactions from within our Sites, which areas are most used and conversely which areas and features are either overlooked or redundant. This information allows us to further improve the functionality of our Sites and Services.</p>
<h3>
    YOUR CALIFORNIA PRIVACY RIGHTS
</h3>
<p>
    Without prejudice to any other rights you may have, California residents may request and obtain from us, once a year, free of charge, a list of third parties, if any, to which we disclosed their personal data for direct marketing purposes during the preceding calendar year and the categories of personal data shared with those third parties. If you are a California resident and wish to obtain that information, please submit your request by sending us an email at privacy@3d4medical.com with “California Privacy Rights” in the subject line or by writing to us at 445 Marine View Avenue Suite 110, Del Mar CA 92014.
</p>
<h3>
