...
window.Modernizr = function(a, b, c) {
    ...
    !y(u, "undefined") && !y(u.call, "undefined")
        ? v = function(a, b) { return u.call(a, b) }
        : v = function(a, b) { return b in a && y(a.constructor.prototype[b], "undefined") }, Function.prototype.bind ||
    (Function.prototype.bind = function(b) {
        ...
        return"ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch
            ? c = !0
            : t(["@media (", m.join("touch-enabled),("), h, ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
    ...
    return e.addTest = function(a, b) {
        ...
        g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + q.join(" ") : ""), e
