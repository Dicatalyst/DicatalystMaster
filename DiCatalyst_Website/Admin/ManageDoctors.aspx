<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ManageDoctors.aspx.cs" Inherits="AdminManageDoctors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="form-group">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <br />
                                        <asp:CheckBoxList ID="chkSpecialityServices" runat="server" RepeatColumns="2" CellPadding="5" CellSpacing="5">
                                        </asp:CheckBoxList>
                                    </ContentTemplate>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Upload Doctors Data </h3>
                ...
                <div class="box-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Import" OnClick="Button1_click" CssClass="btn btn-info" Style="margin-top: 5px;" /><br/><br />
    ...
    <div class="row">
        ...
        <div class="box box-default">
            ...
            <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="GridView1_RowDataBound" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Picture">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgPicture" runat="server" ImageUrl='<%# Eval("Picture")%>' Width="50px" />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:BoundField DataField="fullName" HeaderText="DoctorName" />
						 
                    <asp:BoundField DataField="yearOfExperience" HeaderText="Experience" />
                    <asp:BoundField DataField="designation" HeaderText="Designation" />
                    <asp:BoundField DataField="address" HeaderText="Address" />
                    <asp:BoundField DataField="street" HeaderText="Street" />
                    <asp:BoundField DataField="contactNumber" HeaderText="MobileNo" />
                    ...
                    <asp:BoundField DataField="awardsRecognitions" HeaderText="Awards & Recognitions" />
                    <asp:BoundField DataField="memberships" HeaderText="Memberships" />
                    ...
                    <asp:TemplateField HeaderText="Preferred Doctor">
                        <ItemTemplate>
                            <asp:Label ID="lblPreferred" Visible="False" runat="server" Text='<%#Eval("preferredDoctor") %>'></asp:Label>
                            <asp:CheckBox ID="chkPreferred" runat="server" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEdit" runat="server" CommandName="editRow" CommandArgument="<%#Container.DataItemIndex %>">Edit</asp:LinkButton>
