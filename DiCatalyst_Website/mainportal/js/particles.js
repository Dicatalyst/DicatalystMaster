...
var pJS = function(tag_id, params) {
    ...
    pJS.fn.modes.bubbleParticle = function(p) {
        ...
        /* on click event */
        else if (pJS.interactivity.events.onclick.enable &&
            isInArray("bubble", pJS.interactivity.events.onclick.mode)) {
            ...
            if (pJS.tmp.bubble_clicking) {
                /* size */
                process(pJS.interactivity.modes.bubble.size,
                    pJS.particles.size.value,
                    p.radius_bubble,
                    p.radius,
                    "size");
                /* opacity */
                process(pJS.interactivity.modes.bubble.opacity,
                    pJS.particles.opacity.value,
                    p.opacity_bubble,
                    p.opacity,
                    "opacity");
    ...
    pJS.fn.vendors.eventsListeners = function() {
        ...
        if (pJS.interactivity.events.onhover.enable || pJS.interactivity.events.onclick.enable) {
            ...
            /* el on mousemove */
            pJS.interactivity.el.addEventListener("mousemove",
                function(e) {
    ...
    pJS.fn.vendors.createSvgImg = function(p) {
        ...
        var svgXml = pJS.tmp.source_svg,
            ...
            coloredSvgXml = svgXml.replace(rgbHex,
                function(m, r, g, b) {
                    if (p.color.rgb) {
