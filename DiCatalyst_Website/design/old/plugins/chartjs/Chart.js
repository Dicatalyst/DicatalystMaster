    ...
    Chart.defaults = {
        global: {
            ...
            segmentHighlightColorDefaults: [
                "#CEF6FF", "#47A0DC", "#DAFFB2", "#5BC854", "#FFC2C1", "#FF4244", "#FFE797", "#FFA728", "#F2DAFE",
                "#9265C2", "#DCDCAA", "#D98150"
            ],
                ...
                if (!this.lineArc) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        ...
                        if (this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                            ...
                            var previousOuterPosition =
                                this.getPointPosition(i === 0 ? this.valuesCount - 1 : i - 1, centerOffset);
                            var nextOuterPosition =
                                this.getPointPosition(i === this.valuesCount - 1 ? 0 : i + 1, centerOffset);
    ...
    Chart.Type.extend({
        ...
        addData: function(segment, atIndex, silent) {
            ...
            if (typeof(segment.color) === "undefined") {
                ...
                segment.highlight =
                    Chart.defaults.global.segmentHighlightColorDefaults[index %
    ...
    Chart.Type.extend({
        ...
        addData: function(valuesArray, label) {
            ...
            helpers.each(valuesArray,
                function(value, datasetIndex) {
                    var pointPosition =
                        this.scale.getPointPosition(this.scale.valuesCount, this.scale.calculateCenterOffset(value));
                    this.datasets[datasetIndex].points.push(new this.PointClass({
                        value: value,
                        label: label,
                        datasetLabel: this.datasets[datasetIndex].label,
