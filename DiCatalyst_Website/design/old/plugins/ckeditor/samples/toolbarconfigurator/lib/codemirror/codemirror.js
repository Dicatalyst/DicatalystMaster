(function(q) {
    ...
    function Ob(a) {
        a.node == a.text &&
        (a.node = t("div", null, null, "position: relative"), a.text.parentNode &&
    ...
    function rb(a, b, c, d) {
        return a.cm && a.cm.display.shift || a.extend
            ? (a = b.anchor, d &&
                (b = 0 > y(c, a), b != 0 > y(d, a) ? (a = c, c = d) : b != 0 > y(c, d) && (c = d)), new z(a, c))
            : new z(d || c, c)
    }
    ...
    function de(a, b) {
        b.equals(a.sel) ||
        (a.sel =
            b, a.cm && (a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0, fe(a.cm)), L(a, "cursorActivity", a))
    }
    ...
    function cd(a, b, c, d) {
        ...
        if ("page" == d || "window" == d)
            a = a.display.lineSpace.getBoundingClientRect(), b += a.top +
                ("window" == d ? 0 : window.pageYOffset || (document.documentElement || document.body).scrollTop), d =
                a.left +
                ("window" == d
                    ? 0
                    : window.pageXOffset ||
                    (document.documentElement || document.body).scrollLeft), c.left += d, c.right += d;
        c.top += b;
        c.bottom += b;
        return c
    }
            ...
            try {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    null == e.scrollLeft ||
                        ...
                        (f.scrollLeft =
                            Math.max(0, Math.min(d.scroller.scrollWidth - pa(c), e.scrollLeft)), d.scrollbars
                            .setScrollLeft(f.scrollLeft), d.scroller.scrollLeft = f.scrollLeft, Bc(c));
                    if (e.scrollToPos) {
                        var g = void 0,
    ...
    function Q(a, b, c, d) {
        ...
        if (b >= e.viewTo) ra && Mc(a.doc, b) < e.viewTo && qa(a);
            ...
            f && g
                ? (e.view =
                    e.view.slice(0, f.index).concat(Nb(a, f.lineN, g.lineN))
                    .concat(e.view.slice(g.index)), e.viewTo += d)
                : qa(a)
        }
    ...
    function db(a) {
        a.state.delayingBlurEvent ||
        (a.state.focused &&
                (K(a, "blur", a), a.state.focused = !1, kb(a.display.wrapper, "CodeMirror-focused")), clearInterval(a
                .display.blinker),
    ...
    function ya(a, b) {
        ...
        if (c)
            for (var d, e = 0; e < c.length; ++e)
                ...
                (null == d.from ||
                    !d.marker.widgetNode && 0 == d.from && d.marker.inclusiveLeft && td(a, b, d))) return!0
    }
                            ...
                            for (var x = y = A = C = v = "", z = null, w = Infinity, G = [], H = 0; H < k.length; ++H) {
                                ...
                                "bookmark" == D.type && I.from == n && D.widgetNode
                                    ...
                                    ? (null != I.to && I.to != n && w > I.to && (w = I.to, y = ""), D.className &&
                                        ...
                                        D.startStyle && I.from == n && (A += " " + D.startStyle), D.endStyle &&
                                            I.to == w &&
                                            (y += " " + D.endStyle), D.title && !C && (C = D.title), D.collapsed &&
                                            (!z || 0 > Ve(z.marker, D)) &&
                                            (z = I))
    ...
    q.prototype = {
        ...
        addWidget: function(a, b, c, d, e) {
            ...
            "right" == e
                ...
                : ("left" == e
                    ? h = 0
                    : "middle" == e && (h = (f.sizer.clientWidth - b.offsetWidth) / 2), b.style.left = h + "px");
            c &&
        ...
        column: function() {
            ...
            (this.lastColumnValue =
                aa(this.string,
                    ...
                    this.tabSize,
                    this.lastColumnPos,
                    this.lastColumnValue), this.lastColumnPos = this.start);
