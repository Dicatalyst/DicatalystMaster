...
namespace Admin
{
    public partial class Admin_Manage_Labs : Page
    {
            ...
            using (var excel_con = new OleDbConnection(conString))
            {
                ...
                using (var con = new SqlConnection(consString))
                {
                    using (var sqlBulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        sqlBulkCopy.DestinationTableName = "dbo.lab_Data";

                        //[OPTIONAL]: Map the Excel columns with that of the database table

                        sqlBulkCopy.ColumnMappings.Add("[Lab Name]", "labName");
                        ...
                        sqlBulkCopy.ColumnMappings.Add("Specialities", "specialties");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "deleterow")
            {
                ...
                mngmod.DeleteLabData(Convert.ToInt32(lblId.Text));
                bindGridView();
            }
        }
