...
namespace Admin
{
    public partial class Admin_Manage_Hospital : Page
    {
        ...
        protected void Button1_click(object sender, EventArgs e)
        {
            ...
            using (var excel_con = new OleDbConnection(conString))
            {
                ...
                {
                    new DataColumn("hospitalName", typeof(string)),
                ...
                using (var con = new SqlConnection(consString))
                {
                    using (var sqlBulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        sqlBulkCopy.DestinationTableName = "dbo.hospital_Data";

                        //[OPTIONAL]: Map the Excel columns with that of the database table

                        sqlBulkCopy.ColumnMappings.Add("[Hospital Name]", "hospitalName");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "deleterow")
            {
                ...
                mngmod.DeleteHospitalData(Convert.ToInt32(lblId.Text));
                bindGridView();
            }
        }
