<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Manage_Clinic.aspx.cs" Inherits="Admin.Admin_Manage_Clinic" %>
...
<div class="col-lg-12 col-xs-12">
        ...
        <div class="box box-default" style="border-color: #1e282c;">
            <div class="box-header with-border">
                <h3 class="box-title">Manage Clinic </h3>
                <button type="button" class="btn btn-info pull-right" onclick="open_container();" style="background-color: #3ae3f5; border-color: #3ae3f5;">Add Clinic </button>
            </div>
            <!-- /.box-header -->
            <div class="box-body" style="display: block;">
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        <h4>
                            <b>Upload Clinic Data</b>
                        </h4>
                        <asp:FileUpload ID="FileUpload1" runat="server"/>
                        <asp:Button ID="Button1" runat="server" Text="Import" OnClick="Button1_Click" CssClass="btn btn-info" style="margin-top: 5px;"/>

                    </div>
                </div>

                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand" CssClass="table table-striped table-bordered table-hover">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="clinicName" HeaderText="clinicName"/>
