<%@ Page Title="" Language="C#" MasterPageFile="~/patient/MasterPage.master" AutoEventWireup="true" CodeFile="addressbook.aspx.cs" Inherits="patient_addressbook" %>
...
<div class="row">
    ...
    <div class="pull-right">
        <asp:Button ID="Button2" ValidationGroup="Group21" runat="server" Text="Save" class="btn btn-info" Style="background-color: #3ae3f5; border-color: #3ae3f5"/>
    ...
    <div class="box-body  table-responsive">
        ...
        <%--<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" >
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Address(Res)" HeaderText="Address(Res)"/>
                ...
                <asp:BoundField DataField="Important" HeaderText="Important"/>
