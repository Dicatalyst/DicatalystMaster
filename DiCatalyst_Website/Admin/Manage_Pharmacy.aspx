<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Manage_Pharmacy.aspx.cs" Inherits="Admin.Admin_Manage_Pharmacy" %>
...
<div class="col-lg-12 col-xs-12">
        ...
        <div class="box box-default" style="border-color: #1e282c;">
            <div class="box-header with-border">
                <h3 class="box-title">Manage Pharmacy </h3>

                <button type="button" class="btn btn-info pull-right" onclick="open_container();" style="background-color: #3ae3f5; border-color: #3ae3f5;">Add Pharmacy </button>
            ...
            <div class="box-body" style="display: block;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" OnRowCommand="GridView1_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="pharmacyName" HeaderText="pharmacyName"/>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group has-feedback">
                                        <asp:TextBox ID="txtPharmacyName" runat="server" class="form-control" placeholder="Pharmacy name"></asp:TextBox>
