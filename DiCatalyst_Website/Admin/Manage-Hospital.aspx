<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Manage-Hospital.aspx.cs" Inherits="Admin.Admin_Manage_Hospital" %>
...
<div class="col-lg-12 col-xs-12">
        ...
        <div class="box box-default" style="border-color: #1e282c;">
            <div class="box-header with-border">
                <h3 class="box-title">Manage Hospital </h3>
                <button type="button" class="btn btn-info pull-right" onclick="open_container();" style="background-color: #3ae3f5; border-color: #3ae3f5;">Add Hospital </button>
            </div>
            <!-- /.box-header -->
