...
public partial class userControls_searchbox : System.Web.UI.UserControl
{
    ...
    public static List<string> SearchCustomers(string prefixText, int count)
    {
        using (var conn = new SqlConnection())
        {
            ...
            {
                cmd.CommandText =
                    "select id as specialityid, UPPER(keywords) as keyword from speciality where " +
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName == "view")
        {
            ...
            //Response.Redirect("~/ViewDetails.aspx?did=" + doctorid); //Commented by Ram
