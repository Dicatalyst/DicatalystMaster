<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dentist_FreeListing.aspx.cs" Inherits="Dentist_FreeListing" %>
...
<div class="box-header">
    ...
    <h3 class="box-title"> Dentist Free listing</h3>

    <div class="pull-right">
        <asp:Button ID="btnSaveAddedDentistData" runat="server" Text="Save" class="btn btn-info" OnClick="btnSaveAddedDentistData_Click" />
        ...
        <div class="box-body" style="display: block;">
            ...
            <div class="form-group">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlSpeciality" class="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSpeciality_SelectedIndexChanged1" ></asp:DropDownList>
                        <br />
